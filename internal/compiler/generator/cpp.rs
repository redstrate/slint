    ...
    match expr {
        ...
        Expression::MouseCursor(cursor) => match cursor {
            llr::MouseCursorInner::BuiltIn(cursor) => {
                ...
                format!(
                    "slint::cbindgen_private::MouseCursorInner(slint::cbindgen_private::MouseCursorInner::Tag::BuiltIn, {cursor})"
                )
            }
            llr::MouseCursorInner::CustomMouseCursor { image, hotspot_x, hotspot_y } => {
                ...
                format!(
                    "slint::cbindgen_private::MouseCursorInner(slint::cbindgen_private::MouseCursorInner::Tag::CustomMouseCursor, {image}, {hotspot_x}, {hotspot_y})"
                )
            }
        },
